<table style="width: 600px;margin: 20px auto; background-color: #ffffff; border: 1px solid #ddd; border-spacing: 0;">
    ...
    <tr>
        <td style="padding: 20px;">
        	<p style="color: <?php echo $text_color; ?>"><?php echo sprintf( __('Hi %s:','angelleye-paypal-wp-button-manager'), $customer_name ); ?></p>
            <p style="color: <?php echo $text_color; ?>"><?php echo sprintf( __('Just to let you know — we\'ve received your order #%s, and it is now being processed:','angelleye-paypal-wp-button-manager'), $order_number ); ?></p>
